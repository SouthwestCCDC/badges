...
# Characters
python generate-badge.py -r 2 -c 5 --pip-colors red,red,red,red,red,blue,blue,blue,blue,blue -o output/other -n badge-rc5-empire "SWCCDC" "2024" "" "VADM"
python generate-badge.py -r 2 -c 3 --pip-colors red,red,red,blue,blue,blue -o output/other -n badge-rc5-empire "SWCCDC" "2024" "" "CAPT"
python generate-badge.py -r 2 -c 2 --pip-colors red,red,blue,blue -o output/other -n badge-rc5-empire "SWCCDC" "2024" "" "LT"
